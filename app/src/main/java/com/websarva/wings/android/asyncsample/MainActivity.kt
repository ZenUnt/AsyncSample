...
class MainActivity : AppCompatActivity() {
    // クラス内のprivate定数を宣言するcompanion object
    companion object {
        // ログに記載するタグ用の文字列
        ...
        private const val APP_ID = "557a137e817ca66a375c6b984798b17b"
    }
    ...
    private fun receiveWeatherInfo(urlFull: String) {
        ...
        excuteService.submit(backgroundReceiver)
    }
        ...
        override fun run() {
            ...
            con?.let {
                try {
                    ...
                    it.connect()
                    // HttpURLConnectionオブジェクトからレスポンスデー屋を取得
    ...
    // 非同期でお天気情報を取得した後に、UIスレッドでその情報を表示するためのクラス
